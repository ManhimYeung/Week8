...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "", "SinglePostcodeRequest", "In order to get the details of a postcode\r\nAs a user\r\nI want to be able to make a" +
                    " request for a signle postcode on postcodes.io", ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
#line 8
 testRunner.Given("I had initialised the Single PostcodeService", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
        }
...
#line hidden
#line 20
 testRunner.Then("the JSON response body should match the JSON schema in \"SuccessfulSinglePostcodeR" +
                        "esponse.json\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
